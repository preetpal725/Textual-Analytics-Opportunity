...
for ii in range(0,nnn):
    if actual[ii]==1:
        ...
        if predictions[ii]==1:
            ...
            irir+=1
#The accurary of Decision tree
accur=(irir+rere)/(irir+rere+reir+irre)
print('The accuracy of Decision tree classifier is :',+accur)

#The relevant recall
reca=(rere)/(rere+reir)
print('The relevant recall of Decision tree classifier is :',+reca)
#The irrelevant recall
irca=(irir)/(irre+irir)
print('The irrelevant recall of Decision tree classifier is :',+irca)
