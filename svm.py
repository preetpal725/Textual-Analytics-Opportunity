...
scores=[]
for C in Cs:
    cls=SVC(C=C, kernel='poly', gamma=1, decision_function_shape='ovo')
    cls.fit(xtrain_w2v ,ytrain)
    scores.append(cls.score(xvalid_w2v,yvalid))
...
ax.set_xscale('log')
ax.set_title("SVM-opportunity")    


#SVM

clf = SVC(C=3500, kernel='poly', gamma=1, decision_function_shape='ovo') 
